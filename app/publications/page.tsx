    ...
    <div className="mx-auto max-w-2xl space-y-16 pb-32">
      <div className="space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          A collection of my IT projects, academic work, and technical
          publications.
        </p>
      </div>
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 space-y-3">
          ...
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
            <a
              className="inline-flex flex-1 items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none sm:flex-initial sm:justify-start dark:bg-blue-500 dark:hover:bg-blue-600"
            ...
            {presentationUrl && (
              <a
                className="inline-flex flex-1 items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none sm:flex-initial sm:justify-start dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
